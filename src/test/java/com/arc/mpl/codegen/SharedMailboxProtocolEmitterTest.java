...
class SharedMailboxProtocolEmitterTest {
    ...
    void producerPublishesPayloadBetweenOddAndEvenVersions() {
        ...
        assertEquals("""
            ...
            read __mpl_mailbox0 bank__mpl_mem0 6
            jump _0 strictEqual __mpl_mailbox0 null
            set __mpl_mailbox1 null
            read __mpl_mailbox1 bank__mpl_mem0 7
            ...
            write __mpl_mailbox4 bank__mpl_mem0 6
            write 7 bank__mpl_mem0 8
            write 11 bank__mpl_mem0 9
            write 13 bank__mpl_mem0 10
            write __mpl_mailbox3 bank__mpl_mem0 6
            stop
            """, mlog);
    ...
    void consumerDoubleReadsVersionAndConfirmsItsAcknowledgement() {
        ...
        assertTrue(mlog.contains("write __mpl_mailbox6 bank__mpl_mem0 7"));
        assertTrue(mlog.contains("read __mpl_mailbox7 bank__mpl_mem0 7"));

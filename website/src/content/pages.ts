...
export const pages: Record<PageKey, PageContent> = {
  home: { label: "概览", eyebrow: "Mindustry Processor Language", title: "MPL", lead: "把带类型、对象、集合和模块的源代码，编译为可审查的 MIL、目标版本 mlog、资源报告与可直接导入 Mindustry 的运行时蓝图。" },
  tutorial: { label: "语法教程", eyebrow: "Learn MPL & MIL", title: "从第一行 MPL 到可部署蓝图", lead: "分 15 节 MPL 课程与 9 节 MIL 课程逐步学习语言、硬件契约、游戏对象、Runtime 和目标层宏；每一节都明确可用能力与当前限制。" },

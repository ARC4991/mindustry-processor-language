...
上述间接跳转是 v146 baseline。v159.7 构建会把物理序列保存为 UTF-16 代码单元并直接生成 `printchar`；当前示例由 319 条指令、39 个标签降为 298 条指令、29 个标签，详细差值写在对应 `report.json` 的 `printcharStringOutput` 项中。
